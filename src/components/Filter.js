    ...
    return ( 
        <>
            ...
            <Row className="filter">
                <Col span={11}><SelectFilter value={filter}  changeHandler={filterHanler} options={filterOptions}   placeholder="دستبه بندی" /></Col> <Col  span={11}><SelectFilter  value={sort}  changeHandler={sortHandler} options={sortOptions}  placeholder="بازدید" /></Col>
             </Row>
        </>
     );
}
